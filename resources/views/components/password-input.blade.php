...
<div class="relative" x-data="{ senha: '', show: false }">
    <input
    ...
    <div class="flex items-center mt-1">
        ...
        <svg x-show="senha.length >= {{ $minlength }}" x-cloak class="w-5 h-5 ml-2 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
